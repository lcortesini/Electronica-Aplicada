...
se utilizó el siguiente equipamiento de banco:
\begin{enumerate}
  \item Multímetro digital de banco UNI-T UT890C: empleado para la verificación de componentes y la medición directa del
...
Previo al ensamblado del circuito, se identificaron los terminales del transistor BJT BC547B y se midió su ganancia de
...
\begin{figure}[!ht]
  ...
  \caption{Medición del parámetro $\beta = 284$ del transistor BC547B mediante el multímetro UNI-T UT890C.}
  \label{fig:foto_beta}
\end{figure}
