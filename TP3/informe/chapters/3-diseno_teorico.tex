...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_thevenin.tex}
...
\end{equation}
donde $\beta = 284$ es la ganancia medida del transistor BC546B. Adoptando el límite superior:
\begin{equation}
...
En el Cuadro~\ref{tab:resumen_diseno_teorico} se sintetizan todas las magnitudes calculadas para el punto de reposo y los
