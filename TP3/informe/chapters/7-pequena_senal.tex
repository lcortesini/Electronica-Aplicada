...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_pequena_senal.tex}
...
Tomando el valor de corriente de reposo medido en el laboratorio ($I_{CQ} = 7.683\mA$):7
\begin{equation}
  r_e' = \frac{25.0\mV}{7.683\mA} \approx 3.254\ohm
\end{equation}

La resistencia dinámica de entrada del transistor en emisor común ($h_{ie}$) resulta:
\begin{equation}
  h_{ie} \approx (\beta + 1) \cdot r_e' \approx h_{fe} \cdot \frac{V_T}{I_{CQ}} = 284 \cdot \frac{25.0\mV}{7.683\mA} \approx 924.08\ohm
...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_medicion_zi.tex}
...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_medicion_zo.tex}
